...
- DPV = Digital post til virksomheter. Eget brukernamn/passord. Brukernamn/passord opprettes av Altinn og passord mottas på SMS. [Mer](https://johan0stman.github.io/eformidling/create_users.html#opprette-dpv-bruker)
- DPF = . Brukernamn/passord for både svarut og svarinn (ulike). Begge settene med brukernamn/passord genereres/hentes på [https://svarut.ks.no/](https://svarut.ks.no/). [Veiledning finner du her](https://johan0stman.github.io/eformidling/create_users.html#opprette-dpf-brukere-svarinn-og-svarut)
- DPO = Digital post til offentlige virksomheter. Eget brukernamn/passord. [Opprettes selv](https://johan0stman.github.io/eformidling/create_users.html#opprette-dpo-bruker-altinn-formidlingstjeneste)
- Virksomheten må ha et [virksomhetssertifikat](https://johan0stman.github.io/eformidling/virksomhetssertifikat.html). Offentlig nøkkel sendes til Difi.
...
- [Mer om eFormidling og hvordan det fungerer](https://johan0stman.github.io/eformidling/index.html)
